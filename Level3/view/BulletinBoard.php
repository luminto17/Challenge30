...
<html>
  <head>
    ...
    <title>Level 3 - Bulletin Board</title>
    <style>
      .paging {
        margin: 0 2px;
        padding: 5px;
    ...
    <div style="width:600px;">
      ...
      <ul id="bulletins" class="collapsible popout" data-collapsible="accordion">
        ...
        <li>
                ...
                <div class="card-panel" style="width:520px;">
                  ...
                  <div class="clearfix">
                    <div style="float:left">
                      <a href="<?php echo 'delete.php?id=' . h($bulletin['id']) . '&page=' . h($paginationObj->getCurrentPage()) ?>">
                        <button class="btn waves-effect waves-light red" type="submit" name="action" value="Delete">Delete</button>
                      </a>
                      <a href="<?php echo 'edit.php?id=' . h($bulletin['id']) . '&page=' . h($paginationObj->getCurrentPage()) ?>">
                        <button class="btn waves-effect waves-light" type="submit" name="action" value="Edit">Edit</button>
                      </a>
                    </div>
                    <div style="float:right">
                      <a class="secondary-content"><i class="material-icons">query_builder</i><?php echo h($bulletin['created_at']) ?></a><br>
                      <?php if ($bulletin['updated_at'] !== '0000-00-00 00:00:00') : ?>
                        <a class="secondary-content"><i class="material-icons">restore</i><?php echo h($bulletin['updated_at']) ?></a>
                      <?php endif ?>
                    </div>
                  </div>
                </div>
          ...
          <div class="collapsible-body active"><p style="background-color:white;"></p></div>
        </li><br>
        <?php endforeach ?>
      </ul>
    </div>
